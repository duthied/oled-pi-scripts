...
def setRGBSpeed(speed):
    if speed >= 1 and speed <= 3:
        bus.write_byte_data(hat_addr, rgb_speed_reg, speed&0xff)

def setRGBColor(color):
    if color >= 0 and color <= 6:
        bus.write_byte_data(hat_addr, rgb_color_reg, color&0xff)
...
while True:
    ...
    # if count == 10:
    #     setRGBEffect(0x04)
    #     print("changing RGBEffect: %d"%0x04)
    # elif count == 20:
    #     setRGBEffect(0x02)
    #     print("changing RGBEffect: %d"%0x02)
    # elif count == 30:
    #     setRGBEffect(0x01)
    #     print("changing RGBEffect: %d"%0x01)
    # elif count == 40:
    #     setRGBEffect(0x03)
    #     print("changing RGBEffect: %d"%0x03)
    #     count = 0
    # count += 1
